...
describe("Department", () => {
  ...
  describe("Reading data", () => {
    beforeEach(async () => {
      const testDepOne = new Department({ name: "Department One" });
      await testDepOne.save();

      const testDepTwo = new Department({ name: "Department Two" });
    ...
    it('should return a proper document by "name" with "findOne" method', async () => {
      ...
      expect(department.name).to.equal("Department One");
    });
    after(async () => {
  ...
  describe("Creating data", () => {
    it('should insert new document with "insertOne" method', async () => {
      const department = new Department({ name: "Department One" });
